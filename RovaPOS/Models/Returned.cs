...
{
    public class Returned : INotifyPropertyChanged
    {
        private int id;
        private string name;
        ...
        public Returned(int id, string name, string category, double quantity, double cost, double price, string type, string time, string datex, string barcode, int billnumber, double earned, string details)
        {
            this.id = id;
            this.name = name;
